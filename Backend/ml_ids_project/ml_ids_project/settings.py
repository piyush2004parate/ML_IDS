...
SECRET_KEY = 'django-insecure-@z%z$n73*_(^vw9%ynsu_01wc34w%uag5t0lhl#mpgca+*wp!%'
...
ROOT_URLCONF = 'ml_ids_project.urls'
...
WSGI_APPLICATION = 'ml_ids_project.wsgi.application'
